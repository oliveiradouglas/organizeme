					...
					<form class="form-horizontal" role="form" method="post" id="form-validate" action="<?= generateLink('task', 'register', [$projectId]); ?>" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
					 	...
					 	<div class="form-group">
					    	...
					    	<div class="col-sm-9">
					      		<input type="text" class="form-control" id="name" placeholder="Nome da tarefa" name="task[name]" maxlenght="100" required>
					    	</div>
					  	</div>
					  	...
					  	<div class="form-group">
					    	...
					    	<div class="col-sm-9"> 
					    		<textarea class="form-control" id="description" name="task[description]" rows="4" placeholder="Informe a descrição" maxlength="255"></textarea>
					    	</div>
					  	</div>
